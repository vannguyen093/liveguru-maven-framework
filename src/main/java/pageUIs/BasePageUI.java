...
public class BasePageUI {
    public static final String MY_ACOUNT_LINK = "xpath=//div[@class='footer']//a[text()='My Account']";
    ...
    public static final String LOGOUT_LINK = "xpath=//div[@class='links']//a[text()='Log Out']";
